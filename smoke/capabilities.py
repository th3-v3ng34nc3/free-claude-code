...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    ...
    CapabilityContract(
        ...
        "per_model_mapping",
        "free_claude_code.api.model_router.ModelRouter",
    ...
    CapabilityContract(
        ...
        "smart_rate_limiting",
        "free_claude_code.providers.rate_limit.GlobalRateLimiter",
    ...
    CapabilityContract(
        ...
        "voice_transcription",
        "voice_notes",
        "free_claude_code.messaging.voice.VoiceTranscriptionService",
